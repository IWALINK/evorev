...
const steps = [
  {
    number: 1,
    image: "/register.png",
    imageAlt: "Formulaire de création de compte Evorev",
  ...
  },
  {
    number: 2,
    image: "/investir.png",
    imageAlt: "Formulaire de passage de commande Evorev",
    title: "Choisissez votre Contribution",
    description:
      "Contribuer à partir de 500 CHF dans nos obligations de participation. Suivez l'évolution de votre portefeuille en temps réel.",
  ...
  },
  {
    ...
    imageAlt: "Récapitulatif de commande Evorev complétée",
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="mb-10 relative w-full max-w-[280px] mx-auto">
                  <div className="w-full aspect-square bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl border border-gray-200/50 transition-all duration-300 overflow-hidden relative">
                    <Image
                      src={step.image}
                      alt={step.imageAlt}
                      fill
